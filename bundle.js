...
;// CONCATENATED MODULE: ./src/component/CheckBox.js
...
function CheckBox() {
  var _useState = (0,react.useState)(TASK),
    _useState2 = _slicedToArray(_useState, 2),
    tasks = _useState2[0],
    setTasks = _useState2[1];
  var _useState3 = (0,react.useState)(false),
    _useState4 = _slicedToArray(_useState3, 2),
    allDone = _useState4[0],
    setAllDone = _useState4[1];
  var handleCheck = function handleCheck(id) {
    if (id === -1) {
      ...
      var checkedCount = 0;
      var newArr = tasks.map(function (t) {
        if (t.id == id) {
  ...
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("input", {
    ...
    return /*#__PURE__*/react.createElement("div", {
      ...
      onChange: function onChange(e) {
        return handleCheck(task.id);
      }
    }), task.text);
  })));
}
/* harmony default export */ const component_CheckBox = (CheckBox);
;// CONCATENATED MODULE: ./src/component/DetectOverlapCircle.js
function DetectOverlapCircle_extends() { DetectOverlapCircle_extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return DetectOverlapCircle_extends.apply(this, arguments); }
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || DetectOverlapCircle_unsupportedIterableToArray(arr) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return DetectOverlapCircle_arrayLikeToArray(arr); }
function DetectOverlapCircle_slicedToArray(arr, i) { return DetectOverlapCircle_arrayWithHoles(arr) || DetectOverlapCircle_iterableToArrayLimit(arr, i) || DetectOverlapCircle_unsupportedIterableToArray(arr, i) || DetectOverlapCircle_nonIterableRest(); }
function DetectOverlapCircle_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function DetectOverlapCircle_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return DetectOverlapCircle_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return DetectOverlapCircle_arrayLikeToArray(o, minLen); }
function DetectOverlapCircle_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function DetectOverlapCircle_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function DetectOverlapCircle_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function DetectOverlapCircle() {
  var _useState = (0,react.useState)([]),
    _useState2 = DetectOverlapCircle_slicedToArray(_useState, 2),
    elementsCordinate = _useState2[0],
    setElementsCordinates = _useState2[1];
  ...
  function draw(e) {
    ...
    setElementsCordinates(function (prev) {
  ...
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("h2", null, "Click on anywhere on the screen and see magic"), elementsCordinate.map(function (c) {
    return /*#__PURE__*/react.createElement(Circle, DetectOverlapCircle_extends({}, c, {
      key: c.top + c.left + c.background
    }));
  }));
}
...
/* harmony default export */ const component_DetectOverlapCircle = (DetectOverlapCircle);
;// CONCATENATED MODULE: ./src/hooks/custom-use-effects.js

function customUseEffect(effect, deps) {
  var firstTimeRender = (0,react.useRef)(true);
  var prevDeps = (0,react.useRef)([]);
  var cleanup = (0,react.useRef)(null);
  // first time
  ...
  // deps or no deps
  var depsChanged = deps ? JSON.stringify(deps) !== JSON.stringify(prevDeps.current) : true;
  if (depsChanged) {
    if (cleanup.current) {
      cleanup.current();
    }
...
/* harmony default export */ const custom_use_effects = (customUseEffect);
;// CONCATENATED MODULE: ./src/component/GreenBoard.js
function GreenBoard_toConsumableArray(arr) { return GreenBoard_arrayWithoutHoles(arr) || GreenBoard_iterableToArray(arr) || GreenBoard_unsupportedIterableToArray(arr) || GreenBoard_nonIterableSpread(); }
function GreenBoard_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function GreenBoard_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function GreenBoard_arrayWithoutHoles(arr) { if (Array.isArray(arr)) return GreenBoard_arrayLikeToArray(arr); }
function GreenBoard_slicedToArray(arr, i) { return GreenBoard_arrayWithHoles(arr) || GreenBoard_iterableToArrayLimit(arr, i) || GreenBoard_unsupportedIterableToArray(arr, i) || GreenBoard_nonIterableRest(); }
function GreenBoard_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function GreenBoard_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return GreenBoard_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return GreenBoard_arrayLikeToArray(o, minLen); }
function GreenBoard_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function GreenBoard_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function GreenBoard_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }


function GreenBoard() {
  var _useState = (0,react.useState)([]),
    _useState2 = GreenBoard_slicedToArray(_useState, 2),
    clicked = _useState2[0],
    setClicked = _useState2[1];
  var id = (0,react.useRef)(null);
  var handleClick = function handleClick(i) {
    setClicked([].concat(GreenBoard_toConsumableArray(clicked), [i]));
  };
  custom_use_effects(function () {
    console.log(">> use Effect : ", clicked);
    if (clicked.length == 8) {
      clicked.length = clicked.length - 1;
      setClicked(GreenBoard_toConsumableArray(clicked));
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "green-board-container"
  }, GreenBoard_toConsumableArray(Array(9)).map(function (_, i) {
    // console.log({i})
    return /*#__PURE__*/react.createElement("div", {
      className: "box ".concat(i === 4 ? "hide" : "", " ").concat(clicked.includes(i) ? "green" : ""),
      key: i,
...
/* harmony default export */ const component_GreenBoard = (GreenBoard);
;// CONCATENATED MODULE: ./src/images/image01.jpeg
/* harmony default export */ const image01 = (__webpack_require__.p + "9b9c2fedb532f28e21c08c7844a4192f.jpeg");
;// CONCATENATED MODULE: ./src/images/image02.jpeg
/* harmony default export */ const image02 = (__webpack_require__.p + "41cd172b282d6697fdc38c0c8c310546.jpeg");
;// CONCATENATED MODULE: ./src/component/ImageCompareSlider.js
function ImageCompareSlider_slicedToArray(arr, i) { return ImageCompareSlider_arrayWithHoles(arr) || ImageCompareSlider_iterableToArrayLimit(arr, i) || ImageCompareSlider_unsupportedIterableToArray(arr, i) || ImageCompareSlider_nonIterableRest(); }
function ImageCompareSlider_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function ImageCompareSlider_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return ImageCompareSlider_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return ImageCompareSlider_arrayLikeToArray(o, minLen); }
function ImageCompareSlider_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function ImageCompareSlider_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function ImageCompareSlider_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function ImageCompareSlider() {
  var _useState = (0,react.useState)(false),
    _useState2 = ImageCompareSlider_slicedToArray(_useState, 2),
    isStart = _useState2[0],
    setIsStart = _useState2[1];
  var sliderRef = (0,react.useRef)();
  var overlayRef = (0,react.useRef)();
  ...
  var handleMouseMove = (0,react.useCallback)(function (e) {
    ...
    var imagePos = imageRef.current.getBoundingClientRect();
    var pos = e.pageX - imagePos.left;
    console.log({
      x: e.pageX,
      p: imagePos.left,
      pos: pos
...
/* harmony default export */ const component_ImageCompareSlider = (ImageCompareSlider);
;// CONCATENATED MODULE: ./src/component/ImageZoom.js
...
function ImageZoom_slicedToArray(arr, i) { return ImageZoom_arrayWithHoles(arr) || ImageZoom_iterableToArrayLimit(arr, i) || ImageZoom_unsupportedIterableToArray(arr, i) || ImageZoom_nonIterableRest(); }
function ImageZoom_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function ImageZoom_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return ImageZoom_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return ImageZoom_arrayLikeToArray(o, minLen); }
function ImageZoom_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function ImageZoom_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function ImageZoom_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function ImageZoom() {
  var _useState = (0,react.useState)(false),
    _useState2 = ImageZoom_slicedToArray(_useState, 2),
    isActive = _useState2[0],
    setIsActive = _useState2[1];
  var normalImageRef = (0,react.useRef)();
  var zoomedImageRef = (0,react.useRef)();
  var openZoom = function openZoom(e) {
    console.log("move");
  ...
  var moveLens = function moveLens(e) {
    e.preventDefault();
    var nip = normalImageRef.current.getBoundingClientRect();
    var x = e.pageX - nip.left;
    var y = e.pageY - nip.top;
    console.log("move lens : ", x, y);
    zoomedImageRef.current.style.backgroundPosition = "-".concat(x, "px -").concat(y, "px");
  };
  var closeZoom = function closeZoom() {
    setIsActive(false);
  };
  var normalImageStyle = {
    backgroundImage: "url(".concat(image01, ")"),
    backgroundSize: "".concat(imageSize.width, "px ").concat(imageSize.height, "px"),
    width: "".concat(imageSize.width, "px"),
    height: "".concat(imageSize.height, "px")
  };
  var zoomedImageStyle = {
    backgroundImage: "url(".concat(image01, ")"),
    backgroundSize: zoomType === "click" ? "".concat(zoomedImageSize.width, "px ").concat(zoomedImageSize.height, "px") : "".concat(zoomedImageSize.width * 1.5, "px ").concat(zoomedImageSize.height * 1.5, "px"),
    backgroundRepeat: "no-repeat",
    width: "".concat(zoomedImageSize.width, "px"),
    height: "".concat(zoomedImageSize.height, "px")
  };
...
/* harmony default export */ const component_ImageZoom = (ImageZoom);
;// CONCATENATED MODULE: ./src/component/InfiniteLevelComment.js
function InfiniteLevelComment_toConsumableArray(arr) { return InfiniteLevelComment_arrayWithoutHoles(arr) || InfiniteLevelComment_iterableToArray(arr) || InfiniteLevelComment_unsupportedIterableToArray(arr) || InfiniteLevelComment_nonIterableSpread(); }
function InfiniteLevelComment_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function InfiniteLevelComment_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function InfiniteLevelComment_arrayWithoutHoles(arr) { if (Array.isArray(arr)) return InfiniteLevelComment_arrayLikeToArray(arr); }
function InfiniteLevelComment_slicedToArray(arr, i) { return InfiniteLevelComment_arrayWithHoles(arr) || InfiniteLevelComment_iterableToArrayLimit(arr, i) || InfiniteLevelComment_unsupportedIterableToArray(arr, i) || InfiniteLevelComment_nonIterableRest(); }
function InfiniteLevelComment_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function InfiniteLevelComment_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return InfiniteLevelComment_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return InfiniteLevelComment_arrayLikeToArray(o, minLen); }
function InfiniteLevelComment_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function InfiniteLevelComment_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function InfiniteLevelComment_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }

function InfiniteLevelComment() {
  var _useState = (0,react.useState)(""),
    _useState2 = InfiniteLevelComment_slicedToArray(_useState, 2),
    text = _useState2[0],
    setText = _useState2[1];
  var _useState3 = (0,react.useState)([]),
    _useState4 = InfiniteLevelComment_slicedToArray(_useState3, 2),
  ...
  var onHandleCommentClicked = function onHandleCommentClicked() {
    setComments(function (prev) {
      return [].concat(InfiniteLevelComment_toConsumableArray(prev), [{
        text: text,
        children: []
      }]);
    });
  ...
  var onAddCommentClicked = function onAddCommentClicked(path, commentText) {
    var commentsDataCopy = InfiniteLevelComment_toConsumableArray(comments);
    var updatedComment = commentsDataCopy;
  ...
  var onDeleteClicked = function onDeleteClicked(path) {
    var commentsDataCopy = JSON.parse(JSON.stringify(comments));
    var updatedComment = commentsDataCopy;
    var pathArray = path.split("_");
    for (var i = 0; i < pathArray.length; i++) {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    onClick: onHandleCommentClicked
...
/* harmony default export */ const component_InfiniteLevelComment = (InfiniteLevelComment);
var CommentBlock = function CommentBlock(_ref) {
  var item = _ref.item,
    path = _ref.path,
    onAddCommentClicked = _ref.onAddCommentClicked,
    onDeleteClicked = _ref.onDeleteClicked;
  var _useState5 = (0,react.useState)(),
    _useState6 = InfiniteLevelComment_slicedToArray(_useState5, 2),
    isReplyClicked = _useState6[0],
    setIsReplyClicked = _useState6[1];
  var _useState7 = (0,react.useState)(""),
    _useState8 = InfiniteLevelComment_slicedToArray(_useState7, 2),
    text = _useState8[0],
    setText = _useState8[1];
  var _useState9 = (0,react.useState)(false),
    _useState10 = InfiniteLevelComment_slicedToArray(_useState9, 2),
    isBlockOpen = _useState10[0],
    setIsBlockOpen = _useState10[1];
  var onTextChanged = function onTextChanged(e) {
    setText(e.target.value);
  };
  var onReplyClicked = function onReplyClicked() {
    setIsReplyClicked(true);
  };
  var onAccordionClicked = function onAccordionClicked() {
    setIsBlockOpen(function (prev) {
      return !prev;
    });
  };
  var onCommentAddClicked = function onCommentAddClicked() {
  ...
  return /*#__PURE__*/react.createElement("div", {
  ...
  }, item.children.length ? "^" : ""), /*#__PURE__*/react.createElement("div", null, item.text)), /*#__PURE__*/react.createElement("div", {
    style: {
      textAlign: "left"
    }
  }, isReplyClicked ? /*#__PURE__*/react.createElement("div", {
    style: {
      marginTop: "10px"
    }
  }, /*#__PURE__*/react.createElement("input", {
    ...
    onClick: function onClick() {
      return onDeleteClicked(path);
    }
  }, "Delete")), /*#__PURE__*/react.createElement("div", null, isBlockOpen && item.children.map(function (comment, index) {
    return /*#__PURE__*/react.createElement(CommentBlock, {
      item: comment,
      path: "".concat(path, "_").concat(index),
      onAddCommentClicked: onAddCommentClicked,
      onDeleteClicked: onDeleteClicked
    });
  })));
};
;// CONCATENATED MODULE: ./src/component/MultiSelectInput.js
function MultiSelectInput_toConsumableArray(arr) { return MultiSelectInput_arrayWithoutHoles(arr) || MultiSelectInput_iterableToArray(arr) || MultiSelectInput_unsupportedIterableToArray(arr) || MultiSelectInput_nonIterableSpread(); }
function MultiSelectInput_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function MultiSelectInput_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function MultiSelectInput_arrayWithoutHoles(arr) { if (Array.isArray(arr)) return MultiSelectInput_arrayLikeToArray(arr); }
function MultiSelectInput_slicedToArray(arr, i) { return MultiSelectInput_arrayWithHoles(arr) || MultiSelectInput_iterableToArrayLimit(arr, i) || MultiSelectInput_unsupportedIterableToArray(arr, i) || MultiSelectInput_nonIterableRest(); }
function MultiSelectInput_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function MultiSelectInput_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return MultiSelectInput_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return MultiSelectInput_arrayLikeToArray(o, minLen); }
function MultiSelectInput_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function MultiSelectInput_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function MultiSelectInput_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }

function MultiSelectInput() {
  var _suggestions$users;
  var _useState = (0,react.useState)(""),
    _useState2 = MultiSelectInput_slicedToArray(_useState, 2),
    searchTerm = _useState2[0],
    setSearchTerm = _useState2[1];
  var _useState3 = (0,react.useState)([]),
    _useState4 = MultiSelectInput_slicedToArray(_useState3, 2),
    suggestions = _useState4[0],
    setSuggestions = _useState4[1];
  var _useState5 = (0,react.useState)([]),
    _useState6 = MultiSelectInput_slicedToArray(_useState5, 2),
    selectedUsers = _useState6[0],
    setSelectedUsers = _useState6[1];
  var _useState7 = (0,react.useState)(new Set()),
    _useState8 = MultiSelectInput_slicedToArray(_useState7, 2),
    selectedUserSet = _useState8[0],
    setSelectedUserSet = _useState8[1];
  var _useState9 = (0,react.useState)(0),
    _useState10 = MultiSelectInput_slicedToArray(_useState9, 2),
    activeSuggestion = _useState10[0],
    setActiveSuggestion = _useState10[1];
  ...
  (0,react.useEffect)(function () {
    ...
    fetch("https://dummyjson.com/users/search?q=".concat(searchTerm)).then(function (res) {
      return res.json();
    }).then(function (data) {
      console.log({
        data: data
  ...
  var handleSelectUser = function handleSelectUser() {
    ...
    setSelectedUsers([].concat(MultiSelectInput_toConsumableArray(selectedUsers), [user]));
    setSelectedUserSet(new Set([].concat(MultiSelectInput_toConsumableArray(selectedUserSet), [user.email])));
    setSearchTerm("");
    setSuggestions([]);
    inputRef.current.focus();
  };
  var handlePillClick = function handlePillClick() {
    var user = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    setSelectedUsers(selectedUsers.filter(function (su) {
      return su.id !== user.id;
    }));
    var updatedEmails = new Set(selectedUserSet);
  ...
  var handleKeyDown = function handleKeyDown(e) {
    if (e.key === 'Backspace' && e.target.value === "" && selectedUsers.length > 0) {
      ...
      setActiveSuggestion(function (prev) {
        return prev < suggestions.users.length - 1 ? prev + 1 : prev;
      });
  ...
  return /*#__PURE__*/react.createElement("div", {
  ...
  }, suggestions === null || suggestions === void 0 || (_suggestions$users = suggestions.users) === null || _suggestions$users === void 0 ? void 0 : _suggestions$users.map(function (user, index) {
    return selectedUserSet.has(user.email) ? /*#__PURE__*/react.createElement(react.Fragment, null) : /*#__PURE__*/react.createElement("li", {
    ...
    }), /*#__PURE__*/react.createElement("span", null, user.firstName, " ", user.lastName));
  })))));
}
function Pill(_ref) {
  ...
  return /*#__PURE__*/react.createElement("span", {
    ...
    src: image,
    alt: text
  }), /*#__PURE__*/react.createElement("span", null, text, " \xD7"));
}
;
...
function SelectableGrid_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function SelectableGrid_arrayWithoutHoles(arr) { if (Array.isArray(arr)) return SelectableGrid_arrayLikeToArray(arr); }
function SelectableGrid_slicedToArray(arr, i) { return SelectableGrid_arrayWithHoles(arr) || SelectableGrid_iterableToArrayLimit(arr, i) || SelectableGrid_unsupportedIterableToArray(arr, i) || SelectableGrid_nonIterableRest(); }
function SelectableGrid_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function SelectableGrid_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return SelectableGrid_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return SelectableGrid_arrayLikeToArray(o, minLen); }
function SelectableGrid_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function SelectableGrid_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function SelectableGrid_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }

var TOTAL_ROW = 10;
var TOTAL_COLUMN = 10;
function SelectableGrid(_ref) {
  var _ref$rows = _ref.rows,
    rows = _ref$rows === void 0 ? TOTAL_ROW : _ref$rows,
    _ref$cols = _ref.cols,
    cols = _ref$cols === void 0 ? TOTAL_COLUMN : _ref$cols;
  var _useState = (0,react.useState)(false),
    _useState2 = SelectableGrid_slicedToArray(_useState, 2),
    isMouseDown = _useState2[0],
    setIsMouseDown = _useState2[1];
  var _useState3 = (0,react.useState)([]),
    _useState4 = SelectableGrid_slicedToArray(_useState3, 2),
    selectedBox = _useState4[0],
    setSelectedBox = _useState4[1];
  var handleMouseDown = function handleMouseDown(boxNumber) {
    setIsMouseDown(true);
  ...
  var handleMouseEnter = (0,react.useCallback)(function (boxNumber) {
    if (isMouseDown) {
      var startBox = selectedBox[0];
      var endBox = boxNumber;
      var startRow = Math.floor((startBox - 1) / cols);
      var startCol = (startBox - 1) % cols;
      var endRow = Math.floor((endBox - 1) / cols);
      var endCol = (endBox - 1) % cols;
  ...
  }, SelectableGrid_toConsumableArray(Array(rows * cols).keys()).map(function (i) {
    return /*#__PURE__*/react.createElement("div", {
      className: "box ".concat(selectedBox.includes(i + 1) ? "selected" : ""),
      key: i,
      onMouseDown: function onMouseDown() {
        return handleMouseDown(i + 1);
      },
      onMouseEnter: function onMouseEnter() {
        return handleMouseEnter(i + 1);
      }
    }, i + 1);
  }));
}
/* harmony default export */ const component_SelectableGrid = (SelectableGrid);
;// CONCATENATED MODULE: ./src/component/ShowJobs.js
function ShowJobs_toConsumableArray(arr) { return ShowJobs_arrayWithoutHoles(arr) || ShowJobs_iterableToArray(arr) || ShowJobs_unsupportedIterableToArray(arr) || ShowJobs_nonIterableSpread(); }
function ShowJobs_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function ShowJobs_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function ShowJobs_arrayWithoutHoles(arr) { if (Array.isArray(arr)) return ShowJobs_arrayLikeToArray(arr); }
function ShowJobs_slicedToArray(arr, i) { return ShowJobs_arrayWithHoles(arr) || ShowJobs_iterableToArrayLimit(arr, i) || ShowJobs_unsupportedIterableToArray(arr, i) || ShowJobs_nonIterableRest(); }
function ShowJobs_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function ShowJobs_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return ShowJobs_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return ShowJobs_arrayLikeToArray(o, minLen); }
function ShowJobs_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function ShowJobs_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function ShowJobs_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }

function ShowJobs() {
  var _useState = (0,react.useState)([]),
    _useState2 = ShowJobs_slicedToArray(_useState, 2),
    ids = _useState2[0],
    setIds = _useState2[1];
  var _useState3 = (0,react.useState)([]),
    _useState4 = ShowJobs_slicedToArray(_useState3, 2),
    list = _useState4[0],
  ...
  function getNextData() {
    ...
    var allApi = data.map(function (id) {
      return makeApi(id);
    });
    var allData = Promise.all(allApi);
    allData.then(function (allData) {
      console.log({
        allData: allData
      });
      setList([].concat(ShowJobs_toConsumableArray(list), ShowJobs_toConsumableArray(allData)));
    });
  }
  var handleClickMore = function handleClickMore() {
    getNextData(ids.slice(list.length, list.length + 5));
  };
  var handleCardClick = function handleCardClick(url) {
    window.open(url, '_blank');
  };
  (0,react.useEffect)(function () {
    fetch('https://hacker-news.firebaseio.com/v0/jobstories.json').then(function (res) {
      return res.json();
    }).then(function (data) {
      console.log({
        data: data
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    return /*#__PURE__*/react.createElement("div", {
      onClick: function onClick() {
        return handleCardClick(url);
      },
      className: "job-card",
      key: id
    }, /*#__PURE__*/react.createElement("p", null, "ID: ", /*#__PURE__*/react.createElement("span", null, id)), /*#__PURE__*/react.createElement("h4", null, title), /*#__PURE__*/react.createElement("p", null, "Posted By: ", /*#__PURE__*/react.createElement("span", null, by)));
  })), list.length < ids.length && /*#__PURE__*/react.createElement("button", {
    className: "load-btn",
    onClick: handleClickMore
  }, "load more"));
}
/* harmony default export */ const component_ShowJobs = (ShowJobs);
;// CONCATENATED MODULE: ./src/component/StepBarApp.js
function StepBarApp_slicedToArray(arr, i) { return StepBarApp_arrayWithHoles(arr) || StepBarApp_iterableToArrayLimit(arr, i) || StepBarApp_unsupportedIterableToArray(arr, i) || StepBarApp_nonIterableRest(); }
function StepBarApp_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function StepBarApp_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function StepBarApp_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
function StepBarApp_toConsumableArray(arr) { return StepBarApp_arrayWithoutHoles(arr) || StepBarApp_iterableToArray(arr) || StepBarApp_unsupportedIterableToArray(arr) || StepBarApp_nonIterableSpread(); }
function StepBarApp_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function StepBarApp_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return StepBarApp_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return StepBarApp_arrayLikeToArray(o, minLen); }
function StepBarApp_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function StepBarApp_arrayWithoutHoles(arr) { if (Array.isArray(arr)) return StepBarApp_arrayLikeToArray(arr); }
function StepBarApp_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }

var TOTAL_STEP = 4;
function StepBar(_ref) {
  var _ref$totalSteps = _ref.totalSteps,
    totalSteps = _ref$totalSteps === void 0 ? 0 : _ref$totalSteps,
    _ref$currentStep = _ref.currentStep,
    currentStep = _ref$currentStep === void 0 ? 0 : _ref$currentStep;
  var arr = StepBarApp_toConsumableArray(Array(totalSteps));
  return /*#__PURE__*/react.createElement("div", {
    className: "step-bar-container"
  }, arr.map(function (item, i) {
    return /*#__PURE__*/react.createElement("div", {
      style: {
        backgroundColor: i <= currentStep - 1 ? 'red' : 'yellow'
      },
...
function StepBarApp() {
  var _useState = (0,react.useState)(0),
    _useState2 = StepBarApp_slicedToArray(_useState, 2),
    currentStep = _useState2[0],
    setCurrentStep = _useState2[1];
  var handlePrevious = function handlePrevious() {
    if (currentStep > 0) {
      setCurrentStep(function (curr) {
        return curr - 1;
      });
    }
  };
  ...
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(StepBar, {
    ...
    onClick: handleNext,
    disabled: currentStep == TOTAL_STEP
  }, "next"));
}
;// CONCATENATED MODULE: ./src/component/TypeEffect.js
function TypeEffect_typeof(o) { "@babel/helpers - typeof"; return TypeEffect_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, TypeEffect_typeof(o); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == TypeEffect_typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator["return"] && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(TypeEffect_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, "catch": function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function TypeEffect_slicedToArray(arr, i) { return TypeEffect_arrayWithHoles(arr) || TypeEffect_iterableToArrayLimit(arr, i) || TypeEffect_unsupportedIterableToArray(arr, i) || TypeEffect_nonIterableRest(); }
function TypeEffect_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function TypeEffect_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return TypeEffect_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return TypeEffect_arrayLikeToArray(o, minLen); }
function TypeEffect_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function TypeEffect_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function TypeEffect_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function _sleep() {
  _sleep = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(ms) {
...
var inputs = ['FullStack Developer', 'Frontend Engineer', 'React Native Developer'];
function TypeEffect() {
  var _useState = (0,react.useState)(''),
    _useState2 = TypeEffect_slicedToArray(_useState, 2),
    text = _useState2[0],
    setText = _useState2[1];
  function start(_x2) {
  ...
  function _start() {
    _start = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(index) {
      var currentIndex, input, arr, n, _loop, i;
      return _regeneratorRuntime().wrap(function _callee$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            currentIndex = index % inputs.length;
  ...
  function backword(_x3) {
    return _backword.apply(this, arguments);
  }
  function _backword() {
    _backword = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(index) {
      var currentIndex, input, arr, n, _loop2, i;
  ...
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("div", null, "Inputs : ", inputs.join(", ")), /*#__PURE__*/react.createElement("div", {
    style: {
      color: 'blue'
    }
...
/* harmony default export */ const component_TypeEffect = (TypeEffect);
...
var lodash_memoize = __webpack_require__(654);
...
var esm_getUserLocale = lodash_memoize(getUserLocaleInternal, resolver);
/* harmony default export */ const esm = (esm_getUserLocale);
...
function toYearLabel(locale, formatYear, dates) {
    if (formatYear === void 0) { formatYear = dateFormatter_formatYear; }
    ...
    function renderLabel(date) {
        ...
        return navigationLabel
            ? navigationLabel({
                date: date,
                label: label,
                locale: locale || esm_getUserLocale() || undefined,
                view: view,
            })
            : label;
    }
...
var warning_warning = __webpack_require__(771);
...
var calendarTypeMap = (utils_a = {},
    utils_a[DEPRECATED_CALENDAR_TYPES.ARABIC] = CALENDAR_TYPES.ISLAMIC,
    utils_a[DEPRECATED_CALENDAR_TYPES.HEBREW] = CALENDAR_TYPES.HEBREW,
    utils_a[DEPRECATED_CALENDAR_TYPES.ISO_8601] = CALENDAR_TYPES.ISO_8601,
    utils_a[DEPRECATED_CALENDAR_TYPES.US] = CALENDAR_TYPES.GREGORY,
    utils_a);
...
function mapCalendarType(calendarTypeOrDeprecatedCalendarType) {
    if (isDeprecatedCalendarType(calendarTypeOrDeprecatedCalendarType)) {
        ...
        warning_warning(warned, "Specifying calendarType=\"".concat(calendarTypeOrDeprecatedCalendarType, "\" is deprecated. Use calendarType=\"").concat(calendarType, "\" instead."));
        warned = true;
        return calendarType;
    }
...
function Tile(props) {
    ...
    return (react.createElement("button", { className: dist_clsx(classes, tileClassName), disabled: (minDate && minDateTransform(minDate) > date) ||
...
function Decade(_a) {
    ...
    return (react.createElement(Tile, Decade_assign({}, otherProps, { classes: classesProps, maxDateTransform: getDecadeEnd, minDateTransform: getDecadeStart, view: "century" }), getDecadeLabel(locale, formatYear, date)));
}
...
function Decades(props) {
    ...
    return (react.createElement(TileGroup, { className: "react-calendar__century-view__decades", dateTransform: getDecadeStart, dateType: "decade", end: end, hover: hover, renderTile: function (_a) {
            ...
            return (react.createElement(Decade, Decades_assign({ key: date.getTime() }, otherProps, otherTileProps, { activeStartDate: activeStartDate, currentCentury: start, date: date })));
...
var propTypes_spreadArray = (undefined && undefined.__spreadArray) || function (to, from, pack) {
    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
            if (!ar) ar = Array.prototype.slice.call(from, 0, i);
            ar[i] = from[i];
...
var isCalendarType = prop_types.oneOf(propTypes_spreadArray(propTypes_spreadArray([], calendarTypes, true), deprecatedCalendarTypes, true));
var isClassName = prop_types.oneOfType([
    prop_types.string,
...
var isRef = prop_types.oneOfType([
    prop_types.func,
    prop_types.exact({
        current: prop_types.any,
    }),
]);
var isRange = prop_types.arrayOf(prop_types.oneOfType([prop_types.instanceOf(Date), prop_types.oneOf([null])]).isRequired);
var isValue = prop_types.oneOfType([
    prop_types.instanceOf(Date),
    prop_types.oneOf([null]),
    isRange,
]);
var isViews = prop_types.arrayOf(prop_types.oneOf(allViews));
...
var rangeOf = function (type) {
    return prop_types.arrayOf(type);
};
var tileGroupProps = {
    activeStartDate: prop_types.instanceOf(Date).isRequired,
    hover: prop_types.instanceOf(Date),
    locale: prop_types.string,
    maxDate: isMaxDate,
    minDate: isMinDate,
    onClick: prop_types.func,
    onMouseOver: prop_types.func,
    tileClassName: prop_types.oneOfType([prop_types.func, isClassName]),
    tileContent: prop_types.oneOfType([prop_types.func, prop_types.node]),
    value: isValue,
    valueType: prop_types.oneOf(['century', 'decade', 'year', 'month', 'day']).isRequired,
};
var tileProps = {
    activeStartDate: prop_types.instanceOf(Date).isRequired,
    classes: prop_types.arrayOf(prop_types.string.isRequired).isRequired,
    date: prop_types.instanceOf(Date).isRequired,
    locale: prop_types.string,
    maxDate: isMaxDate,
    minDate: isMinDate,
    onClick: prop_types.func,
    onMouseOver: prop_types.func,
    style: prop_types.objectOf(prop_types.oneOfType([prop_types.string, prop_types.number])),
    tileClassName: prop_types.oneOfType([prop_types.func, isClassName]),
    tileContent: prop_types.oneOfType([prop_types.func, prop_types.node]),
    tileDisabled: prop_types.func,
};
...
var CenturyView = function CenturyView(props) {
    function renderDecades() {
        return react.createElement(Decades, CenturyView_assign({}, props));
    }
    return react.createElement("div", { className: "react-calendar__century-view" }, renderDecades());
};
CenturyView.propTypes = CenturyView_assign(CenturyView_assign({}, tileGroupProps), { showNeighboringCentury: prop_types.bool });
/* harmony default export */ const esm_CenturyView = (CenturyView);
...
function Year(_a) {
    ...
    return (react.createElement(Tile, Year_assign({}, otherProps, { classes: classesProps, maxDateTransform: getYearEnd, minDateTransform: getYearStart, view: "decade" }), formatYear(locale, date)));
}
...
function Years(props) {
    ...
    return (react.createElement(TileGroup, { className: "react-calendar__decade-view__years", dateTransform: getYearStart, dateType: "year", end: end, hover: hover, renderTile: function (_a) {
            ...
            return (react.createElement(Year, Years_assign({ key: date.getTime() }, otherProps, otherTileProps, { activeStartDate: activeStartDate, currentDecade: start, date: date })));
...
var DecadeView = function DecadeView(props) {
    function renderYears() {
        return react.createElement(Years, DecadeView_assign({}, props));
    }
    return react.createElement("div", { className: "react-calendar__decade-view" }, renderYears());
};
DecadeView.propTypes = DecadeView_assign(DecadeView_assign({}, tileGroupProps), { showNeighboringDecade: prop_types.bool });
/* harmony default export */ const esm_DecadeView = (DecadeView);
...
var Month_spreadArray = (undefined && undefined.__spreadArray) || function (to, from, pack) {
    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
            if (!ar) ar = Array.prototype.slice.call(from, 0, i);
            ar[i] = from[i];
...
function Month(_a) {
    ...
    var date = otherProps.date, locale = otherProps.locale;
    return (react.createElement(Tile, Month_assign({}, otherProps, { classes: Month_spreadArray(Month_spreadArray([], classes, true), [Month_className], false), formatAbbr: formatMonthYear, maxDateTransform: getMonthEnd, minDateTransform: getMonthStart, view: "year" }), formatMonth(locale, date)));
}
...
function Months(props) {
    ...
    return (react.createElement(TileGroup, { className: "react-calendar__year-view__months", dateTransform: function (monthIndex) {
            ...
            return (react.createElement(Month, Months_assign({ key: date.getTime() }, otherProps, otherTileProps, { activeStartDate: activeStartDate, date: date })));
        }, start: start, value: value, valueType: valueType }));
}
...
var YearView = function YearView(props) {
    function renderMonths() {
        return react.createElement(Months, YearView_assign({}, props));
    }
    return react.createElement("div", { className: "react-calendar__year-view" }, renderMonths());
};
YearView.propTypes = YearView_assign({}, tileGroupProps);
/* harmony default export */ const esm_YearView = (YearView);
...
function Day(_a) {
    ...
    return (react.createElement(Tile, Day_assign({}, otherProps, { classes: classesProps, formatAbbr: formatLongDate, maxDateTransform: getDayEnd, minDateTransform: getDayStart, view: "month" }), formatDay(locale, date)));
}
...
function Days(props) {
    ...
    return (react.createElement(TileGroup, { className: "react-calendar__month-view__days", count: 7, dateTransform: function (day) {
            ...
            return (react.createElement(Day, Days_assign({ key: date.getTime() }, otherProps, otherTileProps, { activeStartDate: activeStartDate, calendarType: calendarTypeOrDeprecatedCalendarType, currentMonthIndex: monthIndex, date: date })));
...
function Weekdays(props) {
    var calendarTypeOrDeprecatedCalendarType = props.calendarType, _a = props.formatShortWeekday, formatShortWeekday = _a === void 0 ? dateFormatter_formatShortWeekday : _a, _b = props.formatWeekday, formatWeekday = _b === void 0 ? dateFormatter_formatWeekday : _b, locale = props.locale, onMouseLeave = props.onMouseLeave;
    var calendarType = mapCalendarType(calendarTypeOrDeprecatedCalendarType);
    ...
    for (var weekday = 1; weekday <= 7; weekday += 1) {
        ...
        weekdays.push(react.createElement("div", { key: weekday, className: dist_clsx(weekdayClassName, isCurrentDayOfWeek(weekdayDate) && "".concat(weekdayClassName, "--current"), isWeekend(weekdayDate, calendarType) && "".concat(weekdayClassName, "--weekend")) },
            react.createElement("abbr", { "aria-label": abbr, title: abbr }, formatShortWeekday(locale, weekdayDate).replace('.', ''))));
    }
    return (react.createElement(Flex, { className: Weekdays_className, count: 7, onFocus: onMouseLeave, onMouseOver: onMouseLeave }, weekdays));
}
...
function WeekNumber(props) {
    ...
    if (onClickWeekNumber) {
        ...
        return (react.createElement("button", WeekNumber_assign({}, otherProps, { className: WeekNumber_className, onClick: function (event) { return onClickWeekNumber_1(weekNumber_1, date_1, event); }, type: "button" }), children));
    }
    else {
        ...
        return (react.createElement("div", WeekNumber_assign({}, otherProps, { className: WeekNumber_className }), children));
    }
}
...
var MonthView = function MonthView(props) {
    ...
    function renderDays() {
        return react.createElement(Days, MonthView_assign({ calendarType: calendarType }, childProps));
    }
    var className = 'react-calendar__month-view';
    return (react.createElement("div", { className: dist_clsx(className, showWeekNumbers ? "".concat(className, "--weekNumbers") : '') },
...
MonthView.propTypes = MonthView_assign(MonthView_assign({}, tileGroupProps), { calendarType: isCalendarType, formatDay: prop_types.func, formatLongDate: prop_types.func, formatShortWeekday: prop_types.func, formatWeekday: prop_types.func, onClickWeekNumber: prop_types.func, onMouseLeave: prop_types.func, showFixedNumberOfWeeks: prop_types.bool, showNeighboringMonth: prop_types.bool, showWeekNumbers: prop_types.bool });
/* harmony default export */ const esm_MonthView = (MonthView);

;// CONCATENATED MODULE: ./node_modules/react-calendar/dist/esm/Calendar.js
'use client';
var Calendar_assign = (undefined && undefined.__assign) || function () {
...
function getValueType(view) {
    var index = Calendar_allViews.indexOf(view);
...
var Calendar = (0,react.forwardRef)(function Calendar(props, ref) {
    ...
    var _l = (0,react.useState)(Array.isArray(defaultValue)
    ...
    function renderContent(next) {
        ...
        switch (view) {
            case 'century': {
                return (react.createElement(esm_CenturyView, Calendar_assign({ formatYear: formatYear, showNeighboringCentury: showNeighboringCentury }, commonProps)));
            }
            case 'decade': {
                return (react.createElement(esm_DecadeView, Calendar_assign({ formatYear: formatYear, showNeighboringDecade: showNeighboringDecade }, commonProps)));
            }
            case 'year': {
                return (react.createElement(esm_YearView, Calendar_assign({ formatMonth: formatMonth, formatMonthYear: formatMonthYear }, commonProps)));
            }
            case 'month': {
                return (react.createElement(esm_MonthView, Calendar_assign({ calendarType: calendarType, formatDay: formatDay, formatLongDate: formatLongDate, formatShortWeekday: formatShortWeekday, formatWeekday: formatWeekday, onClickWeekNumber: onClickWeekNumber, onMouseLeave: selectRange ? onMouseLeave : undefined, showFixedNumberOfWeeks: typeof showFixedNumberOfWeeks !== 'undefined'
    ...
    var valueArray = Array.isArray(value) ? value : [value];
    return (react.createElement("div", { className: dist_clsx(baseClassName, selectRange && valueArray.length === 1 && "".concat(baseClassName, "--selectRange"), showDoubleView && "".concat(baseClassName, "--doubleView"), className), ref: inputRef },
        renderNavigation(),
...
var isActiveStartDate = prop_types.instanceOf(Date);
var Calendar_isValue = prop_types.oneOfType([prop_types.string, prop_types.instanceOf(Date)]);
var isValueOrValueArray = prop_types.oneOfType([Calendar_isValue, rangeOf(Calendar_isValue)]);
Calendar.propTypes = {
    activeStartDate: isActiveStartDate,
    allowPartialRange: prop_types.bool,
    calendarType: isCalendarType,
    className: isClassName,
    defaultActiveStartDate: isActiveStartDate,
    defaultValue: isValueOrValueArray,
    defaultView: isView,
    formatDay: prop_types.func,
    formatLongDate: prop_types.func,
    formatMonth: prop_types.func,
    formatMonthYear: prop_types.func,
    formatShortWeekday: prop_types.func,
    formatWeekday: prop_types.func,
    formatYear: prop_types.func,
    goToRangeStartOnSelect: prop_types.bool,
    inputRef: isRef,
    locale: prop_types.string,
    maxDate: isMaxDate,
    maxDetail: prop_types.oneOf(Calendar_allViews),
    minDate: isMinDate,
    minDetail: prop_types.oneOf(Calendar_allViews),
    navigationAriaLabel: prop_types.string,
    navigationAriaLive: prop_types.oneOf(['off', 'polite', 'assertive']),
    navigationLabel: prop_types.func,
    next2AriaLabel: prop_types.string,
    next2Label: prop_types.node,
    nextAriaLabel: prop_types.string,
    nextLabel: prop_types.node,
    onActiveStartDateChange: prop_types.func,
    onChange: prop_types.func,
    onClickDay: prop_types.func,
    onClickDecade: prop_types.func,
    onClickMonth: prop_types.func,
    onClickWeekNumber: prop_types.func,
    onClickYear: prop_types.func,
    onDrillDown: prop_types.func,
    onDrillUp: prop_types.func,
    onViewChange: prop_types.func,
    prev2AriaLabel: prop_types.string,
    prev2Label: prop_types.node,
    prevAriaLabel: prop_types.string,
    prevLabel: prop_types.node,
    returnValue: prop_types.oneOf(['start', 'end', 'range']),
    selectRange: prop_types.bool,
    showDoubleView: prop_types.bool,
    showFixedNumberOfWeeks: prop_types.bool,
    showNavigation: prop_types.bool,
    showNeighboringCentury: prop_types.bool,
    showNeighboringDecade: prop_types.bool,
    showNeighboringMonth: prop_types.bool,
    showWeekNumbers: prop_types.bool,
    tileClassName: prop_types.oneOfType([prop_types.func, isClassName]),
    tileContent: prop_types.oneOfType([prop_types.func, prop_types.node]),
...
/* harmony default export */ const esm_Calendar = (Calendar);

;// CONCATENATED MODULE: ./node_modules/react-calendar/dist/esm/index.js
...
var MinuteMark_assign = (undefined && undefined.__assign) || function () {
    MinuteMark_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return MinuteMark_assign.apply(this, arguments);
};


var MinuteMark = (0,react.memo)(function MinuteMark(props) {
    return react.createElement(Mark, MinuteMark_assign({}, props));
});
/* harmony default export */ const esm_MinuteMark = (MinuteMark);

;// CONCATENATED MODULE: ./node_modules/react-clock/dist/esm/shared/hourFormatter.js

function hourFormatter_formatHour(locale, hour) {
    return hour.toLocaleString(locale || esm() || undefined);
}

;// CONCATENATED MODULE: ./node_modules/react-clock/dist/esm/HourMark.js
var HourMark_assign = (undefined && undefined.__assign) || function () {
    HourMark_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return HourMark_assign.apply(this, arguments);
};
var HourMark_rest = (undefined && undefined.__rest) || function (s, e) {
    var t = {};
    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
    if (s != null && typeof Object.getOwnPropertySymbols === "function")
...
var HourMark = (0,react.memo)(function HourMark(_a) {
    var _b = _a.formatHour, formatHour = _b === void 0 ? hourFormatter_formatHour : _b, locale = _a.locale, number = _a.number, otherProps = HourMark_rest(_a, ["formatHour", "locale", "number"]);
    return react.createElement(Mark, HourMark_assign({ number: number ? formatHour(locale, number) : null }, otherProps));
});
/* harmony default export */ const esm_HourMark = (HourMark);
...
var Clock = function Clock(_a) {
    ...
    function renderMinuteMarksFn() {
        ...
        for (var i = 1; i <= 60; i += 1) {
            ...
            if (!isHourMark) {
                minuteMarks.push(react.createElement(esm_MinuteMark, { key: "minute_".concat(i), angle: i * 6, length: minuteMarksLength, name: "minute", width: minuteMarksWidth }));
            }
        }
        return minuteMarks;
    }
    function renderHourMarksFn() {
        ...
        for (var i = 1; i <= 12; i += 1) {
            hourMarks.push(react.createElement(esm_HourMark, { key: "hour_".concat(i), angle: i * 30, formatHour: formatHour, length: hourMarksLength, locale: locale, name: "hour", number: renderNumbers ? i : undefined, width: hourMarksWidth }));
        }
        return hourMarks;
    }
    function renderFace() {
    ...
    return (react.createElement("time", { className: dist_clsx('react-clock', className), dateTime: value instanceof Date ? value.toISOString() : value || undefined, style: {
            width: size,
            height: size,
        } },
        renderFace(),
...
Clock.propTypes = {
    className: prop_types.oneOfType([prop_types.string, prop_types.arrayOf(prop_types.string)]),
    formatHour: prop_types.func,
    ...
    renderHourMarks: prop_types.bool,
    renderMinuteHand: prop_types.bool,
    renderMinuteMarks: prop_types.bool,
    renderNumbers: prop_types.bool,
    renderSecondHand: prop_types.bool,
    secondHandLength: isHandLength,
    secondHandOppositeLength: isOppositeHandLength,
    secondHandWidth: isHandWidth,
    size: prop_types.oneOfType([prop_types.number, prop_types.string]),
    value: prop_types.oneOfType([prop_types.string, prop_types.instanceOf(Date)]),
};
/* harmony default export */ const esm_Clock = (Clock);

;// CONCATENATED MODULE: ./node_modules/react-clock/dist/esm/index.js


/* harmony default export */ const react_clock_dist_esm = (esm_Clock);
...
;// CONCATENATED MODULE: ./node_modules/react-fit/dist/esm/Fit.js
'use client';
...
var Fit_assign = (undefined && undefined.__assign) || function () {
    Fit_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return Fit_assign.apply(this, arguments);
};
var Fit_rest = (undefined && undefined.__rest) || function (s, e) {
    var t = {};
    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
    if (s != null && typeof Object.getOwnPropertySymbols === "function")
...
var Fit_isBrowser = typeof document !== 'undefined';
var isDisplayContentsSupported = Fit_isBrowser && 'CSS' in window && 'supports' in window.CSS && CSS.supports('display', 'contents');
var isMutationObserverSupported = Fit_isBrowser && 'MutationObserver' in window;
...
function alignAxis(_a) {
    ...
    function displayWhereverShrinkedFits() {
        ...
        function shrinkToSize(size) {
            tiny_warning_esm(!minSize || size >= minSize, "<Fit />'s child will not fit anywhere with its current ".concat(minSizeProperty, " of ").concat(minSize, "px."));
            var newSize = Math.max(size, minSize || 0);
            tiny_warning_esm(false, "<Fit />'s child needed to have its ".concat(sizeProperty, " decreased to ").concat(newSize, "px."));
...
function alignSecondaryAxis(args) {
    alignAxis(Fit_assign(Fit_assign({}, args), { axis: args.axis === 'x' ? 'y' : 'x', secondary: true }));
}
function alignBothAxis(args) {
    var invertAxis = args.invertAxis, invertSecondaryAxis = args.invertSecondaryAxis, commonArgs = Fit_rest(args, ["invertAxis", "invertSecondaryAxis"]);
    alignMainAxis(Fit_assign(Fit_assign({}, commonArgs), { invertAxis: invertAxis }));
    alignSecondaryAxis(Fit_assign(Fit_assign({}, commonArgs), { invertAxis: invertSecondaryAxis }));
}
var Fit = /** @class */ (function (_super) {
    ...
    Fit.prototype.componentDidMount = function () {
        ...
        if (!isDisplayContentsSupported) {
            ...
            var element = (0,react_dom.findDOMNode)(this);
    ...
    Fit.propTypes = {
        ...
        invertAxis: prop_types.bool,
        invertSecondaryAxis: prop_types.bool,
        mainAxis: prop_types.oneOf(['x', 'y']),
        spacing: prop_types.oneOfType([
            prop_types.number,
            prop_types.shape({
                bottom: prop_types.number.isRequired,
                left: prop_types.number.isRequired,
                right: prop_types.number.isRequired,
                top: prop_types.number.isRequired,
            }),
        ]),
    };
    return Fit;
}(react.Component));
/* harmony default export */ const esm_Fit = (Fit);

;// CONCATENATED MODULE: ./node_modules/react-fit/dist/esm/index.js


/* harmony default export */ const react_fit_dist_esm = (esm_Fit);

;// CONCATENATED MODULE: ./node_modules/react-datetime-picker/dist/esm/Divider.js
...
/* harmony default export */ const update_input_width_dist_esm = (updateInputWidth);

;// CONCATENATED MODULE: ./node_modules/react-date-picker/dist/esm/DateInput/Input.js



var Input_isBrowser = typeof document !== 'undefined';
var Input_useIsomorphicLayoutEffect = Input_isBrowser ? react.useLayoutEffect : react.useEffect;
var isIEOrEdgeLegacy = Input_isBrowser && /(MSIE|Trident\/|Edge\/)/.test(navigator.userAgent);
var isFirefox = Input_isBrowser && /Firefox/.test(navigator.userAgent);
...
function updateInputWidthOnLoad(element) {
    ...
    function onLoad() {
        update_input_width_dist_esm(element);
    }
...
function Input(_a) {
    ...
    Input_useIsomorphicLayoutEffect(function () {
        if (!inputRef || !inputRef.current) {
            return;
        }
        update_input_width_dist_esm(inputRef.current);
...
;// CONCATENATED MODULE: ./node_modules/react-date-picker/dist/esm/shared/utils.js
/**
 * Returns a value no smaller than min and no larger than max.
 *
 * @param {Date} value Value to return.
 ...
 * @returns {Date} Value between min and max.
 */
function utils_between(value, min, max) {
    if (min && min > value) {
        return min;
    }
    if (max && max < value) {
...
;// CONCATENATED MODULE: ./node_modules/react-date-picker/dist/esm/DateInput/DayInput.js
var DayInput_assign = (undefined && undefined.__assign) || function () {
    DayInput_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return DayInput_assign.apply(this, arguments);
};
var DayInput_rest = (undefined && undefined.__rest) || function (s, e) {
    var t = {};
    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
    if (s != null && typeof Object.getOwnPropertySymbols === "function")
...
function DayInput(_a) {
    var maxDate = _a.maxDate, minDate = _a.minDate, month = _a.month, year = _a.year, otherProps = DayInput_rest(_a, ["maxDate", "minDate", "month", "year"]);
    ...
    return react.createElement(Input, DayInput_assign({ max: maxDay, min: minDay, name: "day" }, otherProps));
}

;// CONCATENATED MODULE: ./node_modules/react-date-picker/dist/esm/DateInput/MonthInput.js
var MonthInput_assign = (undefined && undefined.__assign) || function () {
    ...
    return MonthInput_assign.apply(this, arguments);
};
var MonthInput_rest = (undefined && undefined.__rest) || function (s, e) {
    var t = {};
    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
    if (s != null && typeof Object.getOwnPropertySymbols === "function")
...
function MonthInput(_a) {
    var maxDate = _a.maxDate, minDate = _a.minDate, year = _a.year, otherProps = MonthInput_rest(_a, ["maxDate", "minDate", "year"]);
    ...
    return react.createElement(Input, MonthInput_assign({ max: maxMonth, min: minMonth, name: "month" }, otherProps));
}

;// CONCATENATED MODULE: ./node_modules/react-date-picker/dist/esm/shared/dateFormatter.js

var dateFormatter_formatterCache = new Map();
function dateFormatter_getFormatter(options) {
    return function formatter(locale, date) {
        var localeWithDefault = locale || esm();
        if (!dateFormatter_formatterCache.has(localeWithDefault)) {
            dateFormatter_formatterCache.set(localeWithDefault, new Map());
        }
        var formatterCacheLocale = dateFormatter_formatterCache.get(localeWithDefault);
        if (!formatterCacheLocale.has(options)) {
            formatterCacheLocale.set(options, new Intl.DateTimeFormat(localeWithDefault || undefined, options).format);
        }
        return formatterCacheLocale.get(options)(date);
 ...
 * @returns {Date} Date with hour set to 12.
 */
function dateFormatter_toSafeHour(date) {
    var safeDate = new Date(date);
    return new Date(safeDate.setHours(12));
}
function dateFormatter_getSafeFormatter(options) {
    return function (locale, date) { return dateFormatter_getFormatter(options)(locale, dateFormatter_toSafeHour(date)); };
}
var dateFormatter_formatMonthOptions = { month: 'long' };
var formatShortMonthOptions = { month: 'short' };
var formatMonth = dateFormatter_getSafeFormatter(dateFormatter_formatMonthOptions);
var formatShortMonth = dateFormatter_getSafeFormatter(formatShortMonthOptions);

;// CONCATENATED MODULE: ./node_modules/react-date-picker/dist/esm/DateInput/MonthSelect.js
var MonthSelect_spreadArray = (undefined && undefined.__spreadArray) || function (to, from, pack) {
    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
            if (!ar) ar = Array.prototype.slice.call(from, 0, i);
            ar[i] = from[i];
...
function MonthSelect(_a) {
    ...
    var maxMonth = safeMin(12, maxDate && isSameYear(maxDate) && getMonthHuman(maxDate));
    var minMonth = safeMax(1, minDate && isSameYear(minDate) && getMonthHuman(minDate));
    var dates = MonthSelect_spreadArray([], Array(12), true).map(function (el, index) { return new Date(2019, index, 1); });
    var name = 'month';
    var formatter = short ? formatShortMonth : formatMonth;
    return (react.createElement("select", { "aria-label": ariaLabel, autoFocus: autoFocus, className: dist_clsx("".concat(className, "__input"), "".concat(className, "__").concat(name)), "data-input": "true", "data-select": "true", disabled: disabled, name: name, onChange: onChange, onKeyDown: onKeyDown, ref: inputRef, required: required, value: value !== null ? value : '' },
...
;// CONCATENATED MODULE: ./node_modules/react-date-picker/dist/esm/DateInput/YearInput.js
var YearInput_assign = (undefined && undefined.__assign) || function () {
    YearInput_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return YearInput_assign.apply(this, arguments);
};
var YearInput_rest = (undefined && undefined.__rest) || function (s, e) {
    var t = {};
    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
    if (s != null && typeof Object.getOwnPropertySymbols === "function")
...
function YearInput(_a) {
    var maxDate = _a.maxDate, minDate = _a.minDate, _b = _a.placeholder, placeholder = _b === void 0 ? '----' : _b, valueType = _a.valueType, otherProps = YearInput_rest(_a, ["maxDate", "minDate", "placeholder", "valueType"]);
    ...
    return (react.createElement(Input, YearInput_assign({ max: maxYear, min: minYear, name: "year", placeholder: placeholder, step: yearStep }, otherProps)));
}

;// CONCATENATED MODULE: ./node_modules/react-time-picker/dist/esm/TimeInput/Input.js



var TimeInput_Input_isBrowser = typeof document !== 'undefined';
var TimeInput_Input_useIsomorphicLayoutEffect = TimeInput_Input_isBrowser ? react.useLayoutEffect : react.useEffect;
var Input_isIEOrEdgeLegacy = TimeInput_Input_isBrowser && /(MSIE|Trident\/|Edge\/)/.test(navigator.userAgent);
var Input_isFirefox = TimeInput_Input_isBrowser && /Firefox/.test(navigator.userAgent);
function Input_onFocus(event) {
    var target = event.target;
    if (Input_isIEOrEdgeLegacy) {
        requestAnimationFrame(function () { return target.select(); });
    }
    else {
        target.select();
...
function Input_updateInputWidthOnLoad(element) {
    if (document.readyState === 'complete') {
        return;
    }
    function onLoad() {
...
function Input_updateInputWidthOnFontLoad(element) {
    if (!document.fonts) {
        return;
    }
    var font = getFontShorthand(element);
...
function Input_getSelectionString(input) {
    /**
     * window.getSelection().toString() returns empty string in IE11 and Firefox,
     * so alternatives come first.
     */
...
function Input_makeOnKeyPress(maxLength) {
    if (maxLength === null) {
        return undefined;
    }
    /**
    ...
    return function onKeyPress(event) {
        ...
        var value = input.value;
        var isNumberKey = key.length === 1 && /\d/.test(key);
        var selection = Input_getSelectionString(input);
        if (!isNumberKey || !(selection || value.length < maxLength)) {
            event.preventDefault();
        }
    };
}
function Input_Input(_a) {
    var ariaLabel = _a.ariaLabel, autoFocus = _a.autoFocus, className = _a.className, disabled = _a.disabled, inputRef = _a.inputRef, max = _a.max, min = _a.min, name = _a.name, nameForClass = _a.nameForClass, onChange = _a.onChange, onKeyDown = _a.onKeyDown, onKeyUp = _a.onKeyUp, _b = _a.placeholder, placeholder = _b === void 0 ? '--' : _b, required = _a.required, showLeadingZeros = _a.showLeadingZeros, step = _a.step, value = _a.value;
    TimeInput_Input_useIsomorphicLayoutEffect(function () {
        if (!inputRef || !inputRef.current) {
            return;
        }
        update_input_width_dist_esm(inputRef.current);
        Input_updateInputWidthOnLoad(inputRef.current);
        Input_updateInputWidthOnFontLoad(inputRef.current);
    }, [inputRef, value]);
    var hasLeadingZero = showLeadingZeros &&
        value &&
        Number(value) < 10 &&
    ...
    return (react.createElement(react.Fragment, null,
        hasLeadingZero ? react.createElement("span", { className: "".concat(className, "__leadingZero") }, "0") : null,
        react.createElement("input", { "aria-label": ariaLabel, autoComplete: "off", autoFocus: autoFocus, className: dist_clsx("".concat(className, "__input"), "".concat(className, "__").concat(nameForClass || name), hasLeadingZero && "".concat(className, "__input--hasLeadingZero")), "data-input": "true", disabled: disabled, inputMode: "numeric", max: max, min: min, name: name, onChange: onChange, onFocus: Input_onFocus, onKeyDown: onKeyDown, onKeyPress: Input_makeOnKeyPress(maxLength), onKeyUp: function (event) {
                update_input_width_dist_esm(event.target);
                if (onKeyUp) {
                    onKeyUp(event);
                }
...
var shared_dateFormatter_formatterCache = new Map();
function shared_dateFormatter_getFormatter(options) {
    return function formatter(locale, date) {
        var localeWithDefault = locale || esm();
        if (!shared_dateFormatter_formatterCache.has(localeWithDefault)) {
            shared_dateFormatter_formatterCache.set(localeWithDefault, new Map());
        }
        var formatterCacheLocale = shared_dateFormatter_formatterCache.get(localeWithDefault);
        if (!formatterCacheLocale.has(options)) {
            formatterCacheLocale.set(options, new Intl.DateTimeFormat(localeWithDefault || undefined, options).format);
        }
        return formatterCacheLocale.get(options)(date);
...
var amPmFormatter = shared_dateFormatter_getFormatter({ hour: 'numeric' });
...
function utils_safeMin() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
    }
    return Math.min.apply(Math, args.filter(utils_isValidNumber));
}
function utils_safeMax() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
    }
    return Math.max.apply(Math, args.filter(utils_isValidNumber));
}

;// CONCATENATED MODULE: ./node_modules/react-time-picker/dist/esm/TimeInput/Hour12Input.js
var Hour12Input_assign = (undefined && undefined.__assign) || function () {
    Hour12Input_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return Hour12Input_assign.apply(this, arguments);
};
var Hour12Input_rest = (undefined && undefined.__rest) || function (s, e) {
    var t = {};
    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
    if (s != null && typeof Object.getOwnPropertySymbols === "function")
...
function Hour12Input(_a) {
    var amPm = _a.amPm, maxTime = _a.maxTime, minTime = _a.minTime, value = _a.value, otherProps = Hour12Input_rest(_a, ["amPm", "maxTime", "minTime", "value"]);
    var maxHour = utils_safeMin(12, maxTime &&
        (function () {
    ...
    var minHour = utils_safeMax(1, minTime &&
        (function () {
    ...
    return (react.createElement(Input_Input, Hour12Input_assign({ max: maxHour, min: minHour, name: "hour12", nameForClass: "hour", value: value12 }, otherProps)));
}

;// CONCATENATED MODULE: ./node_modules/react-time-picker/dist/esm/TimeInput/Hour24Input.js
var Hour24Input_assign = (undefined && undefined.__assign) || function () {
    Hour24Input_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return Hour24Input_assign.apply(this, arguments);
};
var Hour24Input_rest = (undefined && undefined.__rest) || function (s, e) {
    var t = {};
    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
    if (s != null && typeof Object.getOwnPropertySymbols === "function")
...
function Hour24Input(_a) {
    var maxTime = _a.maxTime, minTime = _a.minTime, otherProps = Hour24Input_rest(_a, ["maxTime", "minTime"]);
    var maxHour = utils_safeMin(23, maxTime && getHours(maxTime));
    var minHour = utils_safeMax(0, minTime && getHours(minTime));
    return react.createElement(Input_Input, Hour24Input_assign({ max: maxHour, min: minHour, name: "hour24", nameForClass: "hour" }, otherProps));
}

;// CONCATENATED MODULE: ./node_modules/react-time-picker/dist/esm/TimeInput/MinuteInput.js
var MinuteInput_assign = (undefined && undefined.__assign) || function () {
    MinuteInput_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return MinuteInput_assign.apply(this, arguments);
};
var MinuteInput_rest = (undefined && undefined.__rest) || function (s, e) {
    var t = {};
    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
    if (s != null && typeof Object.getOwnPropertySymbols === "function")
...
function MinuteInput(_a) {
    var hour = _a.hour, maxTime = _a.maxTime, minTime = _a.minTime, _b = _a.showLeadingZeros, showLeadingZeros = _b === void 0 ? true : _b, otherProps = MinuteInput_rest(_a, ["hour", "maxTime", "minTime", "showLeadingZeros"]);
    function isSameHour(date) {
        return hour === getHours(date).toString();
    }
    var maxMinute = utils_safeMin(59, maxTime && isSameHour(maxTime) && getMinutes(maxTime));
    var minMinute = utils_safeMax(0, minTime && isSameHour(minTime) && getMinutes(minTime));
    return (react.createElement(Input_Input, MinuteInput_assign({ max: maxMinute, min: minMinute, name: "minute", showLeadingZeros: showLeadingZeros }, otherProps)));
}

;// CONCATENATED MODULE: ./node_modules/react-time-picker/dist/esm/TimeInput/SecondInput.js
var SecondInput_assign = (undefined && undefined.__assign) || function () {
    SecondInput_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return SecondInput_assign.apply(this, arguments);
};
var SecondInput_rest = (undefined && undefined.__rest) || function (s, e) {
    var t = {};
    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
    if (s != null && typeof Object.getOwnPropertySymbols === "function")
...
function SecondInput(_a) {
    var hour = _a.hour, maxTime = _a.maxTime, minTime = _a.minTime, minute = _a.minute, _b = _a.showLeadingZeros, showLeadingZeros = _b === void 0 ? true : _b, otherProps = SecondInput_rest(_a, ["hour", "maxTime", "minTime", "minute", "showLeadingZeros"]);
    function isSameMinute(date) {
        return hour === getHours(date).toString() && minute === getMinutes(date).toString();
    }
    var maxSecond = utils_safeMin(59, maxTime && isSameMinute(maxTime) && getSeconds(maxTime));
    var minSecond = utils_safeMax(0, minTime && isSameMinute(minTime) && getSeconds(minTime));
    return (react.createElement(Input_Input, SecondInput_assign({ max: maxSecond, min: minSecond, name: "second", showLeadingZeros: showLeadingZeros }, otherProps)));
}
...
;// CONCATENATED MODULE: ./node_modules/react-datetime-picker/dist/esm/DateTimeInput/NativeInput.js
...
;// CONCATENATED MODULE: ./node_modules/react-datetime-picker/dist/esm/shared/dateFormatter.js

var esm_shared_dateFormatter_formatterCache = new Map();
function esm_shared_dateFormatter_getFormatter(options) {
    return function formatter(locale, date) {
        var localeWithDefault = locale || esm();
        if (!esm_shared_dateFormatter_formatterCache.has(localeWithDefault)) {
            esm_shared_dateFormatter_formatterCache.set(localeWithDefault, new Map());
        }
        var formatterCacheLocale = esm_shared_dateFormatter_formatterCache.get(localeWithDefault);
        if (!formatterCacheLocale.has(options)) {
            formatterCacheLocale.set(options, new Intl.DateTimeFormat(localeWithDefault || undefined, options).format);
        }
        return formatterCacheLocale.get(options)(date);
...
var dateFormatter_numberFormatterCache = new Map();
function dateFormatter_getNumberFormatter(options) {
    return function (locale, number) {
        var localeWithDefault = locale || esm();
        if (!dateFormatter_numberFormatterCache.has(localeWithDefault)) {
            dateFormatter_numberFormatterCache.set(localeWithDefault, new Map());
        }
        var numberFormatterCacheLocale = dateFormatter_numberFormatterCache.get(localeWithDefault);
        if (!numberFormatterCacheLocale.has(options)) {
            numberFormatterCacheLocale.set(options, new Intl.NumberFormat(localeWithDefault || undefined, options).format);
        }
        return numberFormatterCacheLocale.get(options)(number);
...
var dateFormatter_formatDateOptions = {
    day: 'numeric',
    month: 'numeric',
    year: 'numeric',
};
var dateFormatter_formatDate = esm_shared_dateFormatter_getFormatter(dateFormatter_formatDateOptions);

;// CONCATENATED MODULE: ./node_modules/react-datetime-picker/dist/esm/shared/dates.js
function dates_convert12to24(hour12, amPm) {
    var hour24 = Number(hour12);
    if (amPm === 'am' && hour24 === 12) {
        hour24 = 0;
    }
...
function dates_convert24to12(hour24) {
    var hour12 = Number(hour24) % 12 || 12;
    return [hour12, Number(hour24) < 12 ? 'am' : 'pm'];
}

;// CONCATENATED MODULE: ./node_modules/react-datetime-picker/dist/esm/shared/utils.js
 ...
 * @returns {Date} Value between min and max.
 */
function shared_utils_between(value, min, max) {
    if (min && min > value) {
        return min;
    }
    if (max && max < value) {
...
var utils_nines = ['9', '٩'];
var utils_ninesRegExp = new RegExp("[".concat(utils_nines.join(''), "]"));
var utils_amPmFormatter = esm_shared_dateFormatter_getFormatter({ hour: 'numeric' });
function utils_getAmPmLabels(locale) {
    var amString = utils_amPmFormatter(locale, new Date(2017, 0, 1, 9));
    var pmString = utils_amPmFormatter(locale, new Date(2017, 0, 1, 21));
    var _a = amString.split(utils_ninesRegExp), am1 = _a[0], am2 = _a[1];
    var _b = pmString.split(utils_ninesRegExp), pm1 = _b[0], pm2 = _b[1];
    if (pm2 !== undefined) {
        // If pm2 is undefined, nine was not found in pmString - this locale is not using 12-hour time
        if (am1 !== pm1) {
            return [am1, pm1].map(function (el) { return el.trim(); });
...
;// CONCATENATED MODULE: ./node_modules/react-datetime-picker/dist/esm/DateTimeInput.js
'use client';
var DateTimeInput_assign = (undefined && undefined.__assign) || function () {
    DateTimeInput_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return DateTimeInput_assign.apply(this, arguments);
};
var DateTimeInput_spreadArray = (undefined && undefined.__spreadArray) || function (to, from, pack) {
    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
            if (!ar) ar = Array.prototype.slice.call(from, 0, i);
            ar[i] = from[i];
...
var DateTimeInput_defaultMinDate = new Date();
DateTimeInput_defaultMinDate.setFullYear(1, 0, 1);
DateTimeInput_defaultMinDate.setHours(0, 0, 0, 0);
var DateTimeInput_defaultMaxDate = new Date(8.64e15);
var DateTimeInput_allViews = ['hour', 'minute', 'second'];
function DateTimeInput_toDate(value) {
    if (value instanceof Date) {
        return value;
    }
    return new Date(value);
...
function DateTimeInput_getValue(value, index) {
    var rawValue = Array.isArray(value) ? value[index] : value;
    if (!rawValue) {
        return null;
    }
    var valueDate = DateTimeInput_toDate(rawValue);
    if (isNaN(valueDate.getTime())) {
        throw new Error("Invalid date: ".concat(value));
    }
    return valueDate;
}
function DateTimeInput_getDetailValue(_a, index) {
    var value = _a.value, minDate = _a.minDate, maxDate = _a.maxDate;
    var valuePiece = DateTimeInput_getValue(value, index);
    if (!valuePiece) {
        return null;
    }
    return shared_utils_between(valuePiece, minDate, maxDate);
}
var DateTimeInput_getDetailValueFrom = function (args) { return DateTimeInput_getDetailValue(args, 0); };
...
function DateTimeInput_focus(element) {
    if (element) {
        element.focus();
    }
}
function renderCustomInputs(placeholder, elementFunctions, allowMultipleInstances) {
    ...
    return placeholder.split(pattern).reduce(function (arr, element, index) {
        ...
        var res = DateTimeInput_spreadArray(DateTimeInput_spreadArray([], arr, true), [divider], false);
...
var formatNumber = dateFormatter_getNumberFormatter({ useGrouping: false });
function DateTimeInput(_a) {
    ...
    var _d = (0,react.useState)(null), amPm = _d[0], setAmPm = _d[1];
    var _e = (0,react.useState)(null), year = _e[0], setYear = _e[1];
    var _f = (0,react.useState)(null), month = _f[0], setMonth = _f[1];
    var _g = (0,react.useState)(null), day = _g[0], setDay = _g[1];
    var _h = (0,react.useState)(null), hour = _h[0], setHour = _h[1];
    var _j = (0,react.useState)(null), minute = _j[0], setMinute = _j[1];
    var _k = (0,react.useState)(null), second = _k[0], setSecond = _k[1];
    var _l = (0,react.useState)(null), value = _l[0], setValue = _l[1];
    var amPmInput = (0,react.useRef)(null);
    var yearInput = (0,react.useRef)(null);
    var monthInput = (0,react.useRef)(null);
    var monthSelect = (0,react.useRef)(null);
    var dayInput = (0,react.useRef)(null);
    var hour12Input = (0,react.useRef)(null);
    var hour24Input = (0,react.useRef)(null);
    var minuteInput = (0,react.useRef)(null);
    var secondInput = (0,react.useRef)(null);
    var _m = (0,react.useState)(isWidgetOpenProps), isWidgetOpen = _m[0], setIsWidgetOpenOpen = _m[1];
    var lastPressedKey = (0,react.useRef)();
    (0,react.useEffect)(function () {
        setIsWidgetOpenOpen(isWidgetOpenProps);
    }, [isWidgetOpenProps]);
    (0,react.useEffect)(function () {
        var nextValue = DateTimeInput_getDetailValueFrom({
            value: valueProps,
            minDate: minDate,
            maxDate: maxDate,
        });
        if (nextValue) {
            setAmPm(dates_convert24to12(getHours(nextValue))[1]);
            ...
            setValue(DateTimeInput_toDate(nextValue));
        }
        else {
            setAmPm(null);
            setYear(null);
    ...
    var formatTime = (function () {
        var level = DateTimeInput_allViews.indexOf(maxDetail);
        ...
        return esm_shared_dateFormatter_getFormatter(formatterOptions);
    })();
    var datePlaceholder = (function () {
        ...
        var formattedDate = dateFormatter_formatDate(locale, date);
        ...
        function formatDatePiece(name, dateToFormat) {
            ...
            return esm_shared_dateFormatter_getFormatter(formatterOptions)(locale, dateToFormat).match(/\d{1,}/);
        }
    ...
    var timePlaceholder = (function () {
        ...
        return formatTime(locale, date)
            ...
            .replace(new RegExp(utils_getAmPmLabels(locale).join('|')), 'a');
    })();
    ...
    var maxTime = (function () {
        ...
        return getHoursMinutesSeconds(maxDate || DateTimeInput_defaultMaxDate);
    })();
    var minTime = (function () {
        ...
        return getHoursMinutesSeconds(minDate || DateTimeInput_defaultMinDate);
    })();
    function onClick(event) {
        if (event.target === event.currentTarget) {
            // Wrapper was directly clicked
            var firstInput = event.target.children[1];
            DateTimeInput_focus(firstInput);
        }
    }
    ...
    function onChangeExternal() {
        ...
        if (isEveryValueFilled && isEveryValueValid) {
            ...
            var hour_1 = Number(values.hour24 ||
                (values.hour12 && values.amPm && dates_convert12to24(values.hour12, values.amPm)) ||
                0);
    ...
    function onChange(event) {
        ...
        switch (name) {
            ...
            case 'day':
                ...
                break;
            case 'hour12':
                setHour(value ? dates_convert12to24(value, amPm || 'am').toString() : '');
                break;
            case 'hour24':
                setHour(value);
                break;
    ...
    var commonInputProps = {
        className: className,
        disabled: disabled,
        maxDate: maxDate || DateTimeInput_defaultMaxDate,
        minDate: minDate || DateTimeInput_defaultMinDate,
        onChange: onChange,
        onKeyDown: onKeyDown,
        onKeyUp: onKeyUp,
    ...
    function renderDay(currentMatch, index) {
        ...
        return (react.createElement(DayInput, DateTimeInput_assign({ key: "day" }, commonInputProps, { ariaLabel: dayAriaLabel, 
    ...
    function renderMonth(currentMatch, index) {
        ...
        if (currentMatch.length > 2) {
            return (react.createElement(MonthSelect, DateTimeInput_assign({ key: "month" }, commonInputProps, { ariaLabel: monthAriaLabel, 
                // eslint-disable-next-line jsx-a11y/no-autofocus
        ...
        var showLeadingZerosFromFormat = currentMatch && currentMatch.length === 2;
        return (react.createElement(MonthInput, DateTimeInput_assign({ key: "month" }, commonInputProps, { ariaLabel: monthAriaLabel, 
            // eslint-disable-next-line jsx-a11y/no-autofocus
    ...
    function renderYear(currentMatch, index) {
        return (react.createElement(YearInput, DateTimeInput_assign({ key: "year" }, commonInputProps, { ariaLabel: yearAriaLabel, 
            // eslint-disable-next-line jsx-a11y/no-autofocus
    ...
    function renderHour12(currentMatch, index) {
        ...
        return (react.createElement(Hour12Input, DateTimeInput_assign({ key: "hour12" }, commonInputProps, commonTimeInputProps, { amPm: amPm, ariaLabel: hourAriaLabel, 
            // eslint-disable-next-line jsx-a11y/no-autofocus
    ...
    function renderHour24(currentMatch, index) {
        ...
        var showLeadingZeros = currentMatch ? currentMatch.length === 2 : false;
        return (react.createElement(Hour24Input, DateTimeInput_assign({ key: "hour24" }, commonInputProps, commonTimeInputProps, { ariaLabel: hourAriaLabel, 
            // eslint-disable-next-line jsx-a11y/no-autofocus
    ...
    function renderMinute(currentMatch, index) {
        ...
        var showLeadingZeros = currentMatch ? currentMatch.length === 2 : false;
        return (react.createElement(MinuteInput, DateTimeInput_assign({ key: "minute" }, commonInputProps, commonTimeInputProps, { ariaLabel: minuteAriaLabel, 
            // eslint-disable-next-line jsx-a11y/no-autofocus
    ...
    function renderSecond(currentMatch, index) {
        ...
        return (react.createElement(SecondInput, DateTimeInput_assign({ key: "second" }, commonInputProps, commonTimeInputProps, { ariaLabel: secondAriaLabel, 
            // eslint-disable-next-line jsx-a11y/no-autofocus
    ...
    function renderAmPm(currentMatch, index) {
        return (react.createElement(AmPm, DateTimeInput_assign({ key: "ampm" }, commonInputProps, commonTimeInputProps, { ariaLabel: amPmAriaLabel, 
            // eslint-disable-next-line jsx-a11y/no-autofocus
    ...
    function renderNativeInput() {
        return (react.createElement(NativeInput, { key: "datetime", ariaLabel: nativeInputAriaLabel, disabled: disabled, maxDate: maxDate || DateTimeInput_defaultMaxDate, minDate: minDate || DateTimeInput_defaultMinDate, name: name, onChange: onChangeNative, required: required, value: value, valueType: valueType }));
    }
    return (
...
;// CONCATENATED MODULE: ./node_modules/react-datetime-picker/dist/esm/shared/propTypes.js
var shared_propTypes_spreadArray = (undefined && undefined.__spreadArray) || function (to, from, pack) {
    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
            if (!ar) ar = Array.prototype.slice.call(from, 0, i);
            ar[i] = from[i];
...
var propTypes_allViews = ['hour', 'minute', 'second'];
var propTypes_allValueTypes = shared_propTypes_spreadArray([], propTypes_allViews, true);
var propTypes_isMinDate = function isMinDate(props, propName, componentName) {
    var _a = props, _b = propName, minDate = _a[_b];
    if (!minDate) {
        return null;
    }
...
var propTypes_isMaxDate = function isMaxDate(props, propName, componentName) {
    var _a = props, _b = propName, maxDate = _a[_b];
    if (!maxDate) {
        return null;
    }
...
var isValueType = prop_types.oneOf(propTypes_allValueTypes);
var propTypes_rangeOf = function (type) {
    return prop_types.arrayOf(type);
};

;// CONCATENATED MODULE: ./node_modules/react-datetime-picker/dist/esm/DateTimePicker.js
'use client';
...
var DateTimePicker_rest = (undefined && undefined.__rest) || function (s, e) {
    var t = {};
    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
    if (s != null && typeof Object.getOwnPropertySymbols === "function")
...
var DateTimePicker_isBrowser = typeof document !== 'undefined';
var DateTimePicker_baseClassName = 'react-datetime-picker';
var outsideActionEvents = ['mousedown', 'focusin', 'touchstart'];
var DateTimePicker_allViews = ['hour', 'minute', 'second'];
var iconProps = {
...
var CalendarIcon = (react.createElement("svg", DateTimePicker_assign({}, iconProps, { className: "".concat(DateTimePicker_baseClassName, "__calendar-button__icon ").concat(DateTimePicker_baseClassName, "__button__icon") }),
...
var DateTimePicker_DateTimePicker = function DateTimePicker(props) {
    ...
    var closeCalendar = (0,react.useCallback)(function (_a) {
        var reason = _a.reason;
    ...
    var closeClock = (0,react.useCallback)(function (_a) {
        var reason = _a.reason;
        if (shouldCloseWidgets) {
    ...
    var closeWidgets = (0,react.useCallback)(function (_a) {
        var reason = _a.reason;
    ...
    var onOutsideAction = (0,react.useCallback)(function (event) {
    ...
    var handleOutsideActionListeners = (0,react.useCallback)(function (shouldListen) {
    ...
    function renderInputs() {
        ...
        return (react.createElement("div", { className: "".concat(DateTimePicker_baseClassName, "__wrapper") },
            react.createElement(DateTimeInput, DateTimePicker_assign({}, ariaLabelProps, placeholderProps, { 
                // eslint-disable-next-line jsx-a11y/no-autofocus
                autoFocus: autoFocus, className: "".concat(DateTimePicker_baseClassName, "__inputGroup"), disabled: disabled, format: format, isWidgetOpen: isCalendarOpen || isClockOpen, locale: locale, maxDate: maxDate, maxDetail: maxDetail, minDate: minDate, name: name, onChange: onChange, onInvalidChange: onInvalidChange, required: required, showLeadingZeros: showLeadingZeros, value: valueFrom })),
            clearIcon !== null && (react.createElement("button", { "aria-label": clearAriaLabel, className: "".concat(DateTimePicker_baseClassName, "__clear-button ").concat(DateTimePicker_baseClassName, "__button"), disabled: disabled, onClick: clear, onFocus: stopPropagation, type: "button" }, typeof clearIcon === 'function' ? react.createElement(clearIcon) : clearIcon)),
            calendarIcon !== null && !disableCalendar && (react.createElement("button", { "aria-label": calendarAriaLabel, className: "".concat(DateTimePicker_baseClassName, "__calendar-button ").concat(DateTimePicker_baseClassName, "__button"), disabled: disabled, onClick: toggleCalendar, onFocus: stopPropagation, type: "button" }, typeof calendarIcon === 'function' ? react.createElement(calendarIcon) : calendarIcon))));
    }
    function renderCalendar() {
        ...
        portalContainer = props.portalContainer, value = props.value, calendarProps = DateTimePicker_rest(props, ["calendarClassName", "className", "maxDetail", "onChange", "portalContainer", "value"]);
        var className = "".concat(DateTimePicker_baseClassName, "__calendar");
        var classNames = dist_clsx(className, "".concat(className, "--").concat(isCalendarOpen ? 'open' : 'closed'));
        var calendar = (react.createElement(dist_esm, DateTimePicker_assign({ className: calendarClassName, onChange: function (value) { return onDateChange(value); }, value: value }, calendarProps)));
        return portalContainer ? ((0,react_dom.createPortal)(react.createElement("div", { ref: calendarWrapper, className: classNames }, calendar), portalContainer)) : (react.createElement(react_fit_dist_esm, null,
    ...
    function renderClock() {
        ...
        maxDetail = _a === void 0 ? 'minute' : _a, onChange = props.onChange, portalContainer = props.portalContainer, value = props.value, clockProps = DateTimePicker_rest(props, ["clockClassName", "className", "maxDetail", "onChange", "portalContainer", "value"]);
        var className = "".concat(DateTimePicker_baseClassName, "__clock");
        var classNames = dist_clsx(className, "".concat(className, "--").concat(isClockOpen ? 'open' : 'closed'));
        var valueFrom = (Array.isArray(value) ? value : [value])[0];
        var maxDetailIndex = DateTimePicker_allViews.indexOf(maxDetail);
        var clock = (react.createElement(react_clock_dist_esm, DateTimePicker_assign({ className: clockClassName, renderMinuteHand: maxDetailIndex > 0, renderSecondHand: maxDetailIndex > 1, value: valueFrom }, clockProps)));
        return portalContainer ? ((0,react_dom.createPortal)(react.createElement("div", { ref: clockWrapper, className: classNames }, clock), portalContainer)) : (react.createElement(react_fit_dist_esm, null,
            react.createElement("div", { ref: function (ref) {
                    if (ref && !isClockOpen) {
                        ref.removeAttribute('style');
                    }
    ...
    var eventProps = (0,react.useMemo)(function () { return makeEventProps(otherProps); }, [otherProps]);
    return (react.createElement("div", DateTimePicker_assign({ className: dist_clsx(DateTimePicker_baseClassName, "".concat(DateTimePicker_baseClassName, "--").concat(isCalendarOpen || isClockOpen ? 'open' : 'closed'), "".concat(DateTimePicker_baseClassName, "--").concat(disabled ? 'disabled' : 'enabled'), className), "data-testid": dataTestid, id: id }, eventProps, { onFocus: onFocus, ref: wrapper }),
        renderInputs(),
        renderCalendar(),
        renderClock()));
};
var DateTimePicker_isValue = prop_types.oneOfType([prop_types.string, prop_types.instanceOf(Date)]);
var DateTimePicker_isValueOrValueArray = prop_types.oneOfType([DateTimePicker_isValue, propTypes_rangeOf(DateTimePicker_isValue)]);
DateTimePicker_DateTimePicker.propTypes = {
    amPmAriaLabel: prop_types.string,
    autoFocus: prop_types.bool,
    calendarAriaLabel: prop_types.string,
    calendarClassName: prop_types.oneOfType([prop_types.string, prop_types.arrayOf(prop_types.string)]),
    calendarIcon: prop_types.oneOfType([prop_types.node, prop_types.func]),
    className: prop_types.oneOfType([prop_types.string, prop_types.arrayOf(prop_types.string)]),
    clearAriaLabel: prop_types.string,
    clearIcon: prop_types.oneOfType([prop_types.node, prop_types.func]),
    clockClassName: prop_types.oneOfType([prop_types.string, prop_types.arrayOf(prop_types.string)]),
    closeWidgets: prop_types.bool,
    'data-testid': prop_types.string,
    dayAriaLabel: prop_types.string,
    dayPlaceholder: prop_types.string,
    disableCalendar: prop_types.bool,
    disableClock: prop_types.bool,
    disabled: prop_types.bool,
    format: prop_types.string,
    hourAriaLabel: prop_types.string,
    hourPlaceholder: prop_types.string,
    id: prop_types.string,
    isCalendarOpen: prop_types.bool,
    isClockOpen: prop_types.bool,
    locale: prop_types.string,
    maxDate: propTypes_isMaxDate,
    maxDetail: prop_types.oneOf(DateTimePicker_allViews),
    minDate: propTypes_isMinDate,
    minuteAriaLabel: prop_types.string,
    minutePlaceholder: prop_types.string,
    monthAriaLabel: prop_types.string,
    monthPlaceholder: prop_types.string,
    name: prop_types.string,
    nativeInputAriaLabel: prop_types.string,
    onCalendarClose: prop_types.func,
    onCalendarOpen: prop_types.func,
    onChange: prop_types.func,
    onClockClose: prop_types.func,
    onClockOpen: prop_types.func,
    onFocus: prop_types.func,
    openWidgetsOnFocus: prop_types.bool,
    required: prop_types.bool,
    secondAriaLabel: prop_types.string,
    secondPlaceholder: prop_types.string,
    showLeadingZeros: prop_types.bool,
    value: DateTimePicker_isValueOrValueArray,
    yearAriaLabel: prop_types.string,
    yearPlaceholder: prop_types.string,
};
if (DateTimePicker_isBrowser) {
    DateTimePicker_DateTimePicker.propTypes.portalContainer = prop_types.instanceOf(HTMLElement);
}
/* harmony default export */ const esm_DateTimePicker = (DateTimePicker_DateTimePicker);

;// CONCATENATED MODULE: ./node_modules/react-datetime-picker/dist/esm/index.js


/* harmony default export */ const react_datetime_picker_dist_esm = (esm_DateTimePicker);

;// CONCATENATED MODULE: ./node_modules/react-datetime-picker/dist/DateTimePicker.css
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./node_modules/react-calendar/dist/Calendar.css
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./node_modules/react-clock/dist/Clock.css
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./src/Counter.jsx
function Counter_typeof(o) { "@babel/helpers - typeof"; return Counter_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, Counter_typeof(o); }
...
function Counter_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function Counter_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, Counter_toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function _callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, _isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function _possibleConstructorReturn(self, call) { if (call && (Counter_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return _assertThisInitialized(self); }
...
function Counter_toPropertyKey(t) { var i = Counter_toPrimitive(t, "string"); return "symbol" == Counter_typeof(i) ? i : i + ""; }
function Counter_toPrimitive(t, r) { if ("object" != Counter_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != Counter_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }





var Counter2 = /*#__PURE__*/(/* unused pure expression or super */ null && (function (_Component) {
  function Counter2() {
    var _this;
    ...
    _this = _callSuper(this, Counter2, [].concat(args));
    Counter_defineProperty(_this, "state", {
      endDate: new Date(),
      days: '',
      hours: '',
      minutes: '',
    ...
    Counter_defineProperty(_this, "setRemainingTime", function () {
      var endDate = _this.state.endDate;
      var currentStamp = new Date().getTime();
      var endStamp = endDate.getTime();
      var diffStamp = endStamp - currentStamp;
      var seconds = Math.floor(diffStamp / 1000); // seconds
      var days = Math.floor(seconds / (24 * 60 * 60)); // days
    ...
    Counter_defineProperty(_this, "handleStart", function () {
      console.log('start it');
      _this.setRemainingTime();
      var intervalId = setInterval(_this.setRemainingTime, 1000);
      _this.setState({
        intervalId: intervalId
      });
    });
    Counter_defineProperty(_this, "handleStop", function () {
      console.log('stop it');
      clearInterval(_this.state.intervalId);
    });
    return _this;
  }
  _inherits(Counter2, _Component);
  return _createClass(Counter2, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", null, "Countdown App"), /*#__PURE__*/React.createElement(DateTimePicker, {
        ...
        className: "timer"
      }, /*#__PURE__*/React.createElement("div", null, "days: ", days), /*#__PURE__*/React.createElement("div", null, "hours: ", hours), /*#__PURE__*/React.createElement("div", null, "minutes: ", minutes), /*#__PURE__*/React.createElement("div", null, "seconds: ", seconds)));
    }
  }]);
}(Component)));
function Counter() {
  ...
  var _useState3 = (0,react.useState)({
    ...
    _useState4 = Counter_slicedToArray(_useState3, 2),
    time = _useState4[0],
    setTime = _useState4[1];
  var intervalRef = (0,react.useRef)(undefined);
  var setRemainingTime = function setRemainingTime() {
    var currentStamp = new Date().getTime();
    var endStamp = endDate.getTime();
    var diffStamp = endStamp - currentStamp;
    var seconds = Math.floor(diffStamp / 1000); // seconds
  ...
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("h2", null, "Countdown App"), /*#__PURE__*/react.createElement(react_datetime_picker_dist_esm, {
    onChange: setEndDate,
    value: endDate
  }), /*#__PURE__*/react.createElement("button", {
    id: "startBtn",
    ...
    className: "timer"
  }, /*#__PURE__*/react.createElement("div", null, "days: ", time.days), /*#__PURE__*/react.createElement("div", null, "hours: ", time.hours), /*#__PURE__*/react.createElement("div", null, "minutes: ", time.minutes), /*#__PURE__*/react.createElement("div", null, "seconds: ", time.seconds)));
}
;// CONCATENATED MODULE: ./src/images/event_card.png
/* harmony default export */ const event_card = (__webpack_require__.p + "9a3d6bf01dd10cc607e95023ba03a533.png");
;// CONCATENATED MODULE: ./src/Home.jsx
/* provided dependency */ var Home_React = __webpack_require__(540);

function Home() {
  return /*#__PURE__*/Home_React.createElement("div", null, /*#__PURE__*/Home_React.createElement("h2", null, "Home Componenet"), /*#__PURE__*/Home_React.createElement("img", {
    src: event_card,
    alt: "image",
    width: 300,
    height: 500
  }), /*#__PURE__*/Home_React.createElement("p", null, "Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo obcaecati maiores modi? Excepturi pariatur aliquam, ut facilis aperiam reiciendis incidunt ullam quos, unde suscipit nisi quo corporis laudantium repellat praesentium."));
}
/* harmony default export */ const src_Home = (Home);
;// CONCATENATED MODULE: ./src/Testing.jsx
function Testing_slicedToArray(arr, i) { return Testing_arrayWithHoles(arr) || Testing_iterableToArrayLimit(arr, i) || Testing_unsupportedIterableToArray(arr, i) || Testing_nonIterableRest(); }
function Testing_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function Testing_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return Testing_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return Testing_arrayLikeToArray(o, minLen); }
function Testing_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function Testing_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function Testing_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }

function Testing() {
  var _useState = (0,react.useState)(''),
    _useState2 = Testing_slicedToArray(_useState, 2),
    val = _useState2[0],
    setVal = _useState2[1];
  ...
  var tf = throttle(handleResize, 1000);
  (0,react.useEffect)(function () {
  ...
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("h2", null, "Debounce and throttle examples, open console to check it"), /*#__PURE__*/react.createElement("div", null, " value: ", val), /*#__PURE__*/react.createElement("input", {
    type: "text",
    onChange: debounce(handleChange, 300)
  }));
}
/* harmony default export */ const src_Testing = (Testing);
...
var PAGES = [{
  name: 'Type Effect',
  path: '/type-effect',
  component: component_TypeEffect
}, {
  name: 'infite level comments',
  path: '/infite-level-comments',
  component: component_InfiniteLevelComment
}, {
  ...
  component: component_SelectableGrid
}, {
  name: 'Multi Select Input',
  path: '/multi-select-input',
  component: component_MultiSelectInput
}, {
  name: 'Green Board',
  path: '/green-board',
  component: component_GreenBoard
}, {
  name: 'Image Comparison Slider',
  path: '/image-comparison-slider',
  component: component_ImageCompareSlider
}, {
  name: 'Image Zoom',
  path: '/image-zoom',
  component: component_ImageZoom
}, {
  name: 'Step Bar',
  path: '/step-bar',
  ...
  name: 'Testing',
  path: '/testing',
  component: src_Testing
}];
/* harmony default export */ const pages = (PAGES);
;// CONCATENATED MODULE: ./src/HomePage.jsx
/* provided dependency */ var HomePage_React = __webpack_require__(540);


function HomePage() {
  return /*#__PURE__*/HomePage_React.createElement("div", {
    style: {
      textAlign: 'center'
    }
  }, /*#__PURE__*/HomePage_React.createElement("h2", null, "React Machine Coding Project"), /*#__PURE__*/HomePage_React.createElement("h4", null, "Click on any project and start using it"), /*#__PURE__*/HomePage_React.createElement("ul", {
    className: "card-container",
    style: {
      direction: 'flex'
    }
  }, pages.map(function (page, index) {
    return /*#__PURE__*/HomePage_React.createElement("li", {
      id: "card",
      key: page.path
    }, /*#__PURE__*/HomePage_React.createElement(Link, {
      to: page.path
    }, /*#__PURE__*/HomePage_React.createElement("span", null, index + 1), "-", /*#__PURE__*/HomePage_React.createElement("span", null, page.name)));
  })));
}
/* harmony default export */ const src_HomePage = (HomePage);
;// CONCATENATED MODULE: ./src/App.jsx
/* provided dependency */ var App_React = __webpack_require__(540);
...
function App() {
  ...
  return /*#__PURE__*/App_React.createElement("div", null, /*#__PURE__*/App_React.createElement(HashRouter, null, /*#__PURE__*/App_React.createElement("div", {
    className: "container"
  }, /*#__PURE__*/App_React.createElement(Routes, null, /*#__PURE__*/App_React.createElement(Route, {
    path: "/",
    element: /*#__PURE__*/App_React.createElement(src_HomePage, null)
  }), pages.map(function (page) {
    return /*#__PURE__*/App_React.createElement(Route, {
      key: page.path,
      path: page.path,
      element: /*#__PURE__*/App_React.createElement(page.component, null)
    });
  }), /*#__PURE__*/App_React.createElement(Route, {
    path: "*",
    element: /*#__PURE__*/App_React.createElement(NotFound, null)
  })))));
}
/* harmony default export */ const src_App = (App);
function NotFound() {
  return /*#__PURE__*/App_React.createElement("h2", null, "routes not matching 404 not found");
}
;// CONCATENATED MODULE: ./src/index.jsx
/* provided dependency */ var src_React = __webpack_require__(540);
